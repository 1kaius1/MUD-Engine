...
func insertInitialData() error {
	...
	// Insert New Player Welcome Area (Room 1)
	_, err = DB.Exec(`
		INSERT INTO rooms (id, zone_id, title, description, darkness, status)
		VALUES (?, ?, ?, ?, ?, ?)
	`,
		"00000000-0000-0000-0000-000000000001",
		"00000000-0000-0000-0000-000000000001",
		"New Player Welcome Area",
		"Welcome, new player! We'll review new player stuff here. You should start by reading the sign.",
		0,
		"")
	if err != nil {
		return fmt.Errorf("failed to insert new player room: %w", err)
	}
